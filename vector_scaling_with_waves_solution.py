#!python vector_scaling_with_waves_solution.py --n 10000000 --multiplier 4 --threads 128
import argparse
...
def compute(N, multiplier, threads):
...
if __name__ == '__main__':
    ...
    compute(argsRead.n, argsRead.multiplier, argsRead.threads)